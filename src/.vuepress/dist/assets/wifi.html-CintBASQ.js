import{_ as e}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as t,o as i,c as p,b as c,d as n,a as o,w as l,e as s}from"./app-u7kf_eFM.js";const u={},d=s('<h1 id="用-javascript-连接-wifi" tabindex="-1"><a class="header-anchor" href="#用-javascript-连接-wifi"><span>用 JavaScript 连接 WiFi</span></a></h1><p>WiFi 是 ESP32 系列芯片的主要特色，BeShell 较完整的实现了 WiFi 的 JavaScript API 。下面给出了一些常用的例子，详细 API 请参考 <a href="../api/wifi">WiFi 模块 API</a>。</p><h2 id="_1-arduino-启动工程代码" tabindex="-1"><a class="header-anchor" href="#_1-arduino-启动工程代码"><span>1. Arduino 启动工程代码</span></a></h2>',3),r=s(`<p>使用 WiFi 模块的 Arduion 工程代码如下：</p><div class="language-cpp line-numbers-mode" data-ext="cpp" data-title="cpp"><pre class="language-cpp"><code><span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">include</span> <span class="token string">&lt;BeShell.hpp&gt;</span></span>
