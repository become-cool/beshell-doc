...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),F={href:"https://beconsole.become.cool",target:"_blank",rel:"noopener noreferrer"},V=e("code",null,'console.log("Hello, BeShell!")',-1),y=i(`<div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>Hello, BeShell!
undefined
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>和在 Arduino 的串口工具看到的一样，<code>undefined</code> 是 console.log 的返回值。</p>`,2),M={href:"https://beconsole.become.cool",target:"_blank",rel:"noopener noreferrer"};function L(q,w){const s=t("ExternalLinkIcon");return o(),d("div",null,[r,p,u,v,e("p",null,[e("a",m,[n("VSCode 的下载地址"),l(s)])]),e("ol",_,[h,e("li",null,[b,e("p",null,[n("具体过程可以参考乐鑫官方文档 ："),e("a",S,[n("VSCode ESP-IDF 扩展安装使用指南"),l(s)])]),e("blockquote",null,[e("p",null,[n("国内网络环境a，参考镜像下载安装方案： "),e("a",g,[n("https://gitee.com/EspressifSystems/esp-gitee-tools"),l(s)])])])])]),k,e("p",null,[n("也可以从 "),e("a",f,[n("Github"),l(s)]),n(" 或 "),e("a",x,[n("Gitee 镜像"),l(s)]),n(" 下载最新版本的压缩包，解压后将 "),E,n(" 目录拷贝到工程的 "),I,n(" 目录下。")]),C,e("ol",D,[e("li",null,[n("在浏览器中打开 "),e("a",P,[n("BeConsole"),l(s)]),n(" ，点击右下角的 USB 图标，选择刚才烧录的 ESP32 开发板。")])]),B,e("p",null,[n("在 "),e("a",F,[n("BeConsole"),l(s)]),n(" 的终端界面输入 "),V,n(" 然后回车，可以看到串口输出：")]),y,e("blockquote",null,[e("p",null,[e("a",M,[n("BeConsole"),l(s)]),n(" 是一个 WEB 在线 IDE，提供了终端、文件管理、在线编辑器等功能。")])])])}const T=a(c,[["render",L],["__file","install_esp-idf.html.vue"]]),O=JSON.parse('{"path":"/guide/install_esp-idf.html","title":"在 ESP IDF 工程中安装 BeShell 组件","lang":"zh-CN","frontmatter":{"description":"在 ESP IDF 工程中安装 BeShell 组件 准备工作 ESP IDF 环境下载开发，推荐使用 VSCode IDE 和 VSCode 的 ESP-IDF扩展。 下载并安装 VSCode IDE VSCode 的下载地址 安装好 VSCode 后，在 VSCode 的扩展市场中搜索 ESP-IDF，安装 ESP-IDF 扩展。 ctrl+shi...","head":[["meta",{"property":"og:url","content":"https://vuepress-theme-hope-docs-demo.netlify.app/guide/install_esp-idf.html"}],["meta",{"property":"og:title","content":"在 ESP IDF 工程中安装 BeShell 组件"}],["meta",{"property":"og:description","content":"在 ESP IDF 工程中安装 BeShell 组件 准备工作 ESP IDF 环境下载开发，推荐使用 VSCode IDE 和 VSCode 的 ESP-IDF扩展。 下载并安装 VSCode IDE VSCode 的下载地址 安装好 VSCode 后，在 VSCode 的扩展市场中搜索 ESP-IDF，安装 ESP-IDF 扩展。 ctrl+shi..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"在 ESP IDF 工程中安装 BeShell 组件\\",\\"image\\":[\\"\\"],\\"dateModified\\":null,\\"author\\":[]}"]]},"headers":[{"level":2,"title":"准备工作","slug":"准备工作","link":"#准备工作","children":[]},{"level":2,"title":"创建 ESP-IDF 工程","slug":"创建-esp-idf-工程","link":"#创建-esp-idf-工程","children":[]},{"level":2,"title":"在工程中添加 BeShell 组件","slug":"在工程中添加-beshell-组件","link":"#在工程中添加-beshell-组件","children":[]},{"level":2,"title":"示例代码","slug":"示例代码","link":"#示例代码","children":[]}],"git":{"createdTime":null,"updatedTime":null,"contributors":[]},"readingTime":{"minutes":2.53,"words":759},"filePathRelative":"guide/install_esp-idf.md","autoDesc":true}');export{T as comp,O as data};
