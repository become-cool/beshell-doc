import{_ as i}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as t,o as d,c as o,b as e,d as n,a,e as l}from"./app-CLOzLYWj.js";const c={},r=e("h1",{id:"在-esp-idf-工程中安装-beshell-组件",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#在-esp-idf-工程中安装-beshell-组件"},[e("span",null,"在 ESP IDF 工程中安装 BeShell 组件")])],-1),p=e("h2",{id:"准备工作",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#准备工作"},[e("span",null,"准备工作")])],-1),u=e("p",null,"ESP IDF 环境下载开发，推荐使用 VSCode IDE 和 VSCode 的 ESP-IDF扩展。",-1),v=e("ol",null,[e("li",null,"下载并安装 VSCode IDE")],-1),m={href:"https://code.visualstudio.com/download",target:"_blank",rel:"noopener noreferrer"},_={start:"2"},h=e("li",null,[e("p",null,[n("安装好 VSCode 后，在 VSCode 的扩展市场中搜索 "),e("code",null,"ESP-IDF"),n("，安装 "),e("code",null,"ESP-IDF"),n(" 扩展。")])],-1),b=e("p",null,[e("code",null,"ctrl+shift+p"),n(" 打开命令面板，输入 "),e("code",null,"ESP-IDF: Configure ESP-IDF extension"),n("，在向导的引导下下载安装 ESP-IDF 框架和工具链。建议下载 5.2.1 以上版本。")],-1),k={href:"https://github.com/espressif/vscode-esp-idf-extension/blob/master/docs/tutorial/install.md",target:"_blank",rel:"noopener noreferrer"},S={href:"https://gitee.com/EspressifSystems/esp-gitee-tools",target:"_blank",rel:"noopener noreferrer"},g=l(`<h2 id="创建-esp-idf-工程" tabindex="-1"><a class="header-anchor" href="#创建-esp-idf-工程"><span>创建 ESP-IDF 工程</span></a></h2><ul><li><p><code>ctrl+shift+p</code> 打开命令面板，输入 <code>ESP-IDF: Create new ESP-IDF project</code>，按照向导创建一个空工程。</p></li><li><p>也可以从 esp-idf 的 exampels 目录中拷贝任意示例工程，然后在 VSCode 中打开。</p></li></ul><h2 id="在工程中添加-beshell-组件" tabindex="-1"><a class="header-anchor" href="#在工程中添加-beshell-组件"><span>在工程中添加 BeShell 组件</span></a></h2><p>下一步是在工程中添加 BeShell 组件。</p><p>在工程的 <code>components</code> 目录下执行命令：</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">git</span> clone https://github.com/become-cool/beshell.git <span class="token parameter variable">--recursive</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,8),f={href:"https://github.com/become-cool/beshell",target:"_blank",rel:"noopener noreferrer"},x={href:"https://gitee.com/become-cool/beshell-component",target:"_blank",rel:"noopener noreferrer"},E=e("code",null,"BeShell",-1),I=e("code",null,"components",-1),C=l(`<p>确保工程文件的目录结构像这样：</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>工程根目录
├── components
|   ├── BeShell
|   │   ├── CMakeLists.txt
|   │   ├── src
...
|   └── ...
└── ...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ol start="4"><li>编译并烧录到 ESP32 开发板</li></ol><blockquote><p>如果是通过 <code>ESP IDF: Build, Flash and Monitor</code> 编译烧录，需要关闭 <code>Monitor</code> 终端，以便断开串口连接。</p></blockquote>`,12),D={start:"5"},P={href:"https://beconsole.become.cool",target:"_blank",rel:"noopener noreferrer"},y=l(`<p>一切顺利的话会看到 BeShell 的输出：</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>ESP-ROM:esp32s3-20210327
Build:Mar 27 2021
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),B={href:"https://beconsole.become.cool",target:"_blank",rel:"noopener noreferrer"},F=e("code",null,'console.log("Hello, BeShell!")',-1),V=l(`<div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>Hello, BeShell!
undefined
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>和在 Arduino 的串口工具看到的一样，<code>undefined</code> 是 console.log 的返回值。</p>`,2),w={href:"https://beconsole.become.cool",target:"_blank",rel:"noopener noreferrer"},M=l(`<h2 id="常见问题" tabindex="-1"><a class="header-anchor" href="#常见问题"><span>常见问题</span></a></h2><p>如果运行时崩溃，打印错误：</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>***ERROR*** A stack overflow in task main has been detected.
